...
switch ($env:RUN_ITS)
{
	...
	"true"
	{
		...
		mvn package "--batch-mode" "-Dlicense=skip" "-Dsource.skip=true" "-Denforcer.skip=true" "-Danimal.sniffer.skip=true" "-Dmaven.test.skip=true" "--errors" "-Dmaven.compiler.showDeprecation=true"
		CheckLastExitCode
